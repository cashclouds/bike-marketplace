...
- ✅ Переводы для системы мессенджеров:
  - ✅ contactSeller / Связаться с продавцом
  - ✅ contactWarning / Предупреждение о безопасности
  - ✅ phone / Телефон
  - ✅ telegram / Telegram
  - ✅ whatsapp / WhatsApp
  - ✅ email / Email
  - ✅ useSamePhone / Использовать тот же номер
...
### 9. Система связи через мессенджеры (НОВОЕ)
- ✅ **Контактные поля продавца** в форме создания объявления (Sell page)
  - ✅ Телефон (опционально)
  - ✅ Telegram username (опционально)
  - ✅ WhatsApp номер (опционально)
  - ✅ Email (опционально)
- ✅ **Отображение способов контакта** на странице объявления
  - ✅ Прямые ссылки на мессенджеры (tel:, https://t.me, https://wa.me, mailto:)
  - ✅ Визуальные иконки (emoji) для каждого способа
  - ✅ Всплывающие подсказки при наведении
  - ✅ Информационное сообщение о безопасности
  - ✅ Fallback на профиль продавца, если контакты не указаны
- ✅ **Валидация** контактных полей в backend (Zod schemas)
  - ✅ Максимальные длины полей
  - ✅ Проверка email формата
  - ✅ Сохранение в базе данных (PostgreSQL миграция)
